...
var invalidInputs = map[string]parserTest{
	...
	"unbalanced parens1": {source: "(+ 1 2 3", err: NewParseError("Unexpected end of file", "unbalanced parens1", token{tokenEOF, pos(8), 1, "EOF"})},
	"unbalanced parens2": {source: "(* (+ 1 2 3) (+ 4 5 6", err: NewParseError("Unexpected end of file", "unbalanced parens2", token{tokenEOF, pos(21), 1, "EOF"})},
	"unbalanced parens3": {source: "(((", err: NewParseError("Unexpected end of file", "unbalanced parens3", token{tokenEOF, pos(3), 1, "EOF"})},
	"unbalanced parens4": {source: ")(", err: NewParseError("Unexpected right paren", "unbalanced parens4", token{tokenRightParen, pos(1), 1, ")"})},
	"unterminated list":  {source: "(a b c d e f g h", err: NewParseError("Unexpected end of file", "unterminated list", token{tokenRightParen, pos(16), 1, "EOF"})},
	"unterminated dot":   {source: "(fun . x", err: NewParseError("Unexpected token, expected tokenRightParen", "unterminated dot", token{tokenEOF, pos(8), 1, "EOF"})},
}
